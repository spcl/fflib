...
PETSC_EXTERN void PETSC_STDCALL  vecmin_(Vec x,PetscInt *p,PetscReal *val, int *__ierr ){
*__ierr = VecMin(
...
PETSC_EXTERN void PETSC_STDCALL  vecsetvalues_(Vec x,PetscInt *ni, PetscInt ix[], PetscScalar y[],InsertMode *iora, int *__ierr ){
*__ierr = VecSetValues(
...
PETSC_EXTERN void PETSC_STDCALL  vecsetvaluesblocked_(Vec x,PetscInt *ni, PetscInt ix[], PetscScalar y[],InsertMode *iora, int *__ierr ){
*__ierr = VecSetValuesBlocked(
	(Vec)PetscToPointer((x) ),*ni,ix,y,*iora);
}
PETSC_EXTERN void PETSC_STDCALL  vecsetvalueslocal_(Vec x,PetscInt *ni, PetscInt ix[], PetscScalar y[],InsertMode *iora, int *__ierr ){
