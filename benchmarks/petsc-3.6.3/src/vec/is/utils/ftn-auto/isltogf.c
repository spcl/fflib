...
PETSC_EXTERN void PETSC_STDCALL  isglobaltolocalmappingapplyis_(ISLocalToGlobalMapping mapping,ISGlobalToLocalMappingType *type,IS is,IS *newis, int *__ierr ){
