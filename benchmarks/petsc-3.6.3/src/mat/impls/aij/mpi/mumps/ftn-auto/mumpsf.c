...
#define matmumpssetschurindices_ MATMUMPSSETSCHURINDICES
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpssetschurindices_ matmumpssetschurindices
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpscreateschurcomplement_ MATMUMPSCREATESCHURCOMPLEMENT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpscreateschurcomplement_ matmumpscreateschurcomplement
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpsgetschurcomplement_ MATMUMPSGETSCHURCOMPLEMENT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpsgetschurcomplement_ matmumpsgetschurcomplement
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpsrestoreschurcomplement_ MATMUMPSRESTORESCHURCOMPLEMENT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpsrestoreschurcomplement_ matmumpsrestoreschurcomplement
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpsinvertschurcomplement_ MATMUMPSINVERTSCHURCOMPLEMENT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpsinvertschurcomplement_ matmumpsinvertschurcomplement
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpssolveschurcomplement_ MATMUMPSSOLVESCHURCOMPLEMENT
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpssolveschurcomplement_ matmumpssolveschurcomplement
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define matmumpssolveschurcomplementtranspose_ MATMUMPSSOLVESCHURCOMPLEMENTTRANSPOSE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define matmumpssolveschurcomplementtranspose_ matmumpssolveschurcomplementtranspose
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  matmumpssetschurindices_(Mat F,PetscInt *size,PetscInt idxs[], int *__ierr ){
*__ierr = MatMumpsSetSchurIndices(
	(Mat)PetscToPointer((F) ),*size,idxs);
}
PETSC_EXTERN void PETSC_STDCALL  matmumpscreateschurcomplement_(Mat F,Mat* S, int *__ierr ){
*__ierr = MatMumpsCreateSchurComplement(
	(Mat)PetscToPointer((F) ),S);
}
PETSC_EXTERN void PETSC_STDCALL  matmumpsgetschurcomplement_(Mat F,Mat* S, int *__ierr ){
*__ierr = MatMumpsGetSchurComplement(
	(Mat)PetscToPointer((F) ),S);
}
PETSC_EXTERN void PETSC_STDCALL  matmumpsrestoreschurcomplement_(Mat F,Mat* S, int *__ierr ){
*__ierr = MatMumpsRestoreSchurComplement(
	(Mat)PetscToPointer((F) ),S);
}
PETSC_EXTERN void PETSC_STDCALL  matmumpsinvertschurcomplement_(Mat F, int *__ierr ){
*__ierr = MatMumpsInvertSchurComplement(
	(Mat)PetscToPointer((F) ));
}
PETSC_EXTERN void PETSC_STDCALL  matmumpssolveschurcomplement_(Mat F,Vec rhs,Vec sol, int *__ierr ){
*__ierr = MatMumpsSolveSchurComplement(
	(Mat)PetscToPointer((F) ),
	(Vec)PetscToPointer((rhs) ),
	(Vec)PetscToPointer((sol) ));
}
PETSC_EXTERN void PETSC_STDCALL  matmumpssolveschurcomplementtranspose_(Mat F,Vec rhs,Vec sol, int *__ierr ){
*__ierr = MatMumpsSolveSchurComplementTranspose(
	(Mat)PetscToPointer((F) ),
	(Vec)PetscToPointer((rhs) ),
	(Vec)PetscToPointer((sol) ));
}
