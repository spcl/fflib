...
PETSC_EXTERN void PETSC_STDCALL  matsetvalues_(Mat mat,PetscInt *m, PetscInt idxm[],PetscInt *n, PetscInt idxn[], PetscScalar v[],InsertMode *addv, int *__ierr ){
*__ierr = MatSetValues(
...
PETSC_EXTERN void PETSC_STDCALL  matsetvaluesblocked_(Mat mat,PetscInt *m, PetscInt idxm[],PetscInt *n, PetscInt idxn[], PetscScalar v[],InsertMode *addv, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  matsetvalueslocal_(Mat mat,PetscInt *nrow, PetscInt irow[],PetscInt *ncol, PetscInt icol[], PetscScalar y[],InsertMode *addv, int *__ierr ){
*__ierr = MatSetValuesLocal(
	(Mat)PetscToPointer((mat) ),*nrow,irow,*ncol,icol,y,*addv);
}
PETSC_EXTERN void PETSC_STDCALL  matsetvaluesblockedlocal_(Mat mat,PetscInt *nrow, PetscInt irow[],PetscInt *ncol, PetscInt icol[], PetscScalar y[],InsertMode *addv, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  matgetsize_(Mat mat,PetscInt *m,PetscInt *n, int *__ierr ){
*__ierr = MatGetSize(
	(Mat)PetscToPointer((mat) ),m,n);
}
PETSC_EXTERN void PETSC_STDCALL  matgetlocalsize_(Mat mat,PetscInt *m,PetscInt *n, int *__ierr ){
*__ierr = MatGetLocalSize(
	(Mat)PetscToPointer((mat) ),m,n);
}
PETSC_EXTERN void PETSC_STDCALL  matgetownershiprangecolumn_(Mat mat,PetscInt *m,PetscInt *n, int *__ierr ){
*__ierr = MatGetOwnershipRangeColumn(
	(Mat)PetscToPointer((mat) ),m,n);
}
PETSC_EXTERN void PETSC_STDCALL  matgetownershiprange_(Mat mat,PetscInt *m,PetscInt *n, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  matgetsubmatrix_(Mat mat,IS isrow,IS iscol,MatReuse *cll,Mat *newmat, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  matsetvaluesadifor_(Mat mat,PetscInt *nl,void*v, int *__ierr ){
