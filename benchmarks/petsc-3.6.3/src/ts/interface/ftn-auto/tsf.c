...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define tsadjointcomputecostintegrand_ TSADJOINTCOMPUTECOSTINTEGRAND
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define tsadjointcomputecostintegrand_ tsadjointcomputecostintegrand
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  tsgettimestepnumber_(TS ts,PetscInt *iter, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  tsadjointcomputecostintegrand_(TS ts,PetscReal *t,Vec y,Vec q, int *__ierr ){
*__ierr = TSAdjointComputeCostIntegrand(
	(TS)PetscToPointer((ts) ),*t,
	(Vec)PetscToPointer((y) ),
...
PETSC_EXTERN void PETSC_STDCALL  tsmonitordefault_(TS ts,PetscInt *step,PetscReal *ptime,Vec v,void*dummy, int *__ierr ){
*__ierr = TSMonitorDefault(
	(TS)PetscToPointer((ts) ),*step,*ptime,
	(Vec)PetscToPointer((v) ),dummy);
}
PETSC_EXTERN void PETSC_STDCALL  tssetretainstages_(TS ts,PetscBool *flg, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  tsmonitor_(TS ts,PetscInt *step,PetscReal *ptime,Vec u, int *__ierr ){
*__ierr = TSMonitor(
	(TS)PetscToPointer((ts) ),*step,*ptime,
	(Vec)PetscToPointer((u) ));
}
...
PETSC_EXTERN void PETSC_STDCALL  tserrorweightednorm2_(TS ts,Vec U,Vec Y,PetscReal *norm, int *__ierr ){
*__ierr = TSErrorWeightedNorm2(
	(TS)PetscToPointer((ts) ),
	(Vec)PetscToPointer((U) ),
	(Vec)PetscToPointer((Y) ),norm);
}
PETSC_EXTERN void PETSC_STDCALL  tserrorweightednorminfinity_(TS ts,Vec U,Vec Y,PetscReal *norm, int *__ierr ){
*__ierr = TSErrorWeightedNormInfinity(
	(TS)PetscToPointer((ts) ),
	(Vec)PetscToPointer((U) ),
	(Vec)PetscToPointer((Y) ),norm);
}
PETSC_EXTERN void PETSC_STDCALL  tserrorweightednorm_(TS ts,Vec U,Vec Y,NormType *wnormtype,PetscReal *norm, int *__ierr ){
*__ierr = TSErrorWeightedNorm(
	(TS)PetscToPointer((ts) ),
	(Vec)PetscToPointer((U) ),
	(Vec)PetscToPointer((Y) ),*wnormtype,norm);
}
