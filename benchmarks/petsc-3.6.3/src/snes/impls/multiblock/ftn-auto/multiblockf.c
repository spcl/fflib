...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  snesmultiblocksetfields_(SNES snes, char name[],PetscInt *n, PetscInt *fields, int *__ierr ){
*__ierr = SNESMultiblockSetFields(
	(SNES)PetscToPointer((snes) ),name,*n,fields);
}
PETSC_EXTERN void PETSC_STDCALL  snesmultiblocksetis_(SNES snes, char name[],IS is, int *__ierr ){
