...
PETSC_EXTERN void PETSC_STDCALL  snesfassetmonitor_(SNES snes,PetscBool *flg, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  snesfasgetcoarsesolve_(SNES snes,SNES *smooth, int *__ierr ){
