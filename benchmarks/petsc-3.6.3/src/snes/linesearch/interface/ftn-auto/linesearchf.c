...
PETSC_EXTERN void PETSC_STDCALL  sneslinesearchsetmonitor_(SNESLineSearch linesearch,PetscBool *flg, int *__ierr ){
*__ierr = SNESLineSearchSetMonitor(
	(SNESLineSearch)PetscToPointer((linesearch) ),*flg);
}
PETSC_EXTERN void PETSC_STDCALL  sneslinesearchgetmonitor_(SNESLineSearch linesearch,PetscViewer *monitor, int *__ierr ){
