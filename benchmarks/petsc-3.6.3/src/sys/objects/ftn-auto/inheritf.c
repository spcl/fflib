...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  petscobjectreference_(PetscObject obj, int *__ierr ){
*__ierr = PetscObjectReference(
	(PetscObject)PetscToPointer((obj) ));
}
PETSC_EXTERN void PETSC_STDCALL  petscobjectgetreference_(PetscObject obj,PetscInt *cnt, int *__ierr ){
*__ierr = PetscObjectGetReference(
	(PetscObject)PetscToPointer((obj) ),cnt);
}
PETSC_EXTERN void PETSC_STDCALL  petscobjectdereference_(PetscObject obj, int *__ierr ){
