...
PETSC_EXTERN void PETSC_STDCALL  petscviewerasciipushtab_(PetscViewer viewer, int *__ierr ){
*__ierr = PetscViewerASCIIPushTab(
	(PetscViewer)PetscToPointer((viewer) ));
}
PETSC_EXTERN void PETSC_STDCALL  petscviewerasciipoptab_(PetscViewer viewer, int *__ierr ){
