...
PETSC_EXTERN void PETSC_STDCALL  petscrandomgetseed_(PetscRandom r,unsigned long *seed, int *__ierr ){
*__ierr = PetscRandomGetSeed(
	(PetscRandom)PetscToPointer((r) ),seed);
}
PETSC_EXTERN void PETSC_STDCALL  petscrandomsetseed_(PetscRandom r,unsigned long *seed, int *__ierr ){
