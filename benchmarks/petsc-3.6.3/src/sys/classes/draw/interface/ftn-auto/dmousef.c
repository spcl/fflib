...
PETSC_EXTERN void PETSC_STDCALL  petscdrawsynchronizedgetmousebutton_(PetscDraw draw,PetscDrawButton *button,PetscReal *x_user,PetscReal *y_user,PetscReal *x_phys,PetscReal *y_phys, int *__ierr ){
