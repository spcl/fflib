...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  petscinfodeactivateclass_(int *objclass, int *__ierr ){
*__ierr = PetscInfoDeactivateClass(*objclass);
}
PETSC_EXTERN void PETSC_STDCALL  petscinfoactivateclass_(int *objclass, int *__ierr ){
