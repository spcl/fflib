...
PETSC_EXTERN void PETSC_STDCALL  petscsortintwithdataarray_(PetscInt *n,PetscInt i[],void*Ii,size_t *size,void*work, int *__ierr ){
*__ierr = PetscSortIntWithDataArray(*n,i,Ii,*size,work);
}
