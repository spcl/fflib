...
PETSC_EXTERN void PETSC_STDCALL  kspfcgsettruncationtype_(KSP ksp,KSPFCGTruncationType *truncstrat, int *__ierr ){
*__ierr = KSPFCGSetTruncationType(
	(KSP)PetscToPointer((ksp) ),*truncstrat);
}
PETSC_EXTERN void PETSC_STDCALL  kspfcggettruncationtype_(KSP ksp,KSPFCGTruncationType *truncstrat, int *__ierr ){
