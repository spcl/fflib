...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  kspgltrsetradius_(KSP ksp,PetscReal *radius, int *__ierr ){
*__ierr = KSPGLTRSetRadius(
	(KSP)PetscToPointer((ksp) ),*radius);
}
PETSC_EXTERN void PETSC_STDCALL  kspgltrgetnormd_(KSP ksp,PetscReal *norm_d, int *__ierr ){
*__ierr = KSPGLTRGetNormD(
	(KSP)PetscToPointer((ksp) ),norm_d);
}
PETSC_EXTERN void PETSC_STDCALL  kspgltrgetobjfcn_(KSP ksp,PetscReal *o_fcn, int *__ierr ){
*__ierr = KSPGLTRGetObjFcn(
	(KSP)PetscToPointer((ksp) ),o_fcn);
}
PETSC_EXTERN void PETSC_STDCALL  kspgltrgetmineig_(KSP ksp,PetscReal *e_min, int *__ierr ){
*__ierr = KSPGLTRGetMinEig(
	(KSP)PetscToPointer((ksp) ),e_min);
}
PETSC_EXTERN void PETSC_STDCALL  kspgltrgetlambda_(KSP ksp,PetscReal *lambda, int *__ierr ){
