...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define pcgetinitialguessnonzero_ PCGETINITIALGUESSNONZERO
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define pcgetinitialguessnonzero_ pcgetinitialguessnonzero
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  pcgetsetupfailedreason_(PC pc,PetscInt *reason, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  pcsetinitialguessnonzero_(PC pc,PetscBool *flg, int *__ierr ){
*__ierr = PCSetInitialGuessNonzero(
	(PC)PetscToPointer((pc) ),*flg);
}
PETSC_EXTERN void PETSC_STDCALL  pcgetinitialguessnonzero_(PC pc,PetscBool *flg, int *__ierr ){
*__ierr = PCGetInitialGuessNonzero(
	(PC)PetscToPointer((pc) ),flg);
}
