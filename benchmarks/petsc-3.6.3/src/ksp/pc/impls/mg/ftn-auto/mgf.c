...
PETSC_EXTERN void PETSC_STDCALL  pcmgsetgalerkin_(PC pc,PetscBool *use, int *__ierr ){
*__ierr = PCMGSetGalerkin(
	(PC)PetscToPointer((pc) ),*use);
}
PETSC_EXTERN void PETSC_STDCALL  pcmggetgalerkin_(PC pc,PetscBool  *galerkin, int *__ierr ){
*__ierr = PCMGGetGalerkin(
	(PC)PetscToPointer((pc) ),galerkin);
}
PETSC_EXTERN void PETSC_STDCALL  pcmgsetnumbersmoothdown_(PC pc,PetscInt *n, int *__ierr ){
*__ierr = PCMGSetNumberSmoothDown(
	(PC)PetscToPointer((pc) ),*n);
}
PETSC_EXTERN void PETSC_STDCALL  pcmgsetnumbersmoothup_(PC pc,PetscInt *n, int *__ierr ){
