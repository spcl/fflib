...
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexlocalizecoordinate_ DMPLEXLOCALIZECOORDINATE
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexlocalizecoordinate_ dmplexlocalizecoordinate
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
#define dmplexlocalizecoordinates_ DMPLEXLOCALIZECOORDINATES
#elif !defined(PETSC_HAVE_FORTRAN_UNDERSCORE) && !defined(FORTRANDOUBLEUNDERSCORE)
#define dmplexlocalizecoordinates_ dmplexlocalizecoordinates
#endif
#ifdef PETSC_HAVE_FORTRAN_CAPS
...
PETSC_EXTERN void PETSC_STDCALL  dmplexlocalizecoordinate_(DM dm, PetscScalar in[],PetscScalar out[], int *__ierr ){
*__ierr = DMPlexLocalizeCoordinate(
	(DM)PetscToPointer((dm) ),in,out);
}
PETSC_EXTERN void PETSC_STDCALL  dmplexlocalizecoordinates_(DM dm, int *__ierr ){
*__ierr = DMPlexLocalizeCoordinates(
	(DM)PetscToPointer((dm) ));
}
