...
extern "C" {
#endif
PETSC_EXTERN void PETSC_STDCALL  dmdaglobaltonaturalbegin_(DM da,Vec g,InsertMode *mode,Vec l, int *__ierr ){
*__ierr = DMDAGlobalToNaturalBegin(
	(DM)PetscToPointer((da) ),
	(Vec)PetscToPointer((g) ),*mode,
	(Vec)PetscToPointer((l) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmdaglobaltonaturalend_(DM da,Vec g,InsertMode *mode,Vec l, int *__ierr ){
*__ierr = DMDAGlobalToNaturalEnd(
	(DM)PetscToPointer((da) ),
	(Vec)PetscToPointer((g) ),*mode,
	(Vec)PetscToPointer((l) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmdanaturaltoglobalbegin_(DM da,Vec g,InsertMode *mode,Vec l, int *__ierr ){
*__ierr = DMDANaturalToGlobalBegin(
	(DM)PetscToPointer((da) ),
	(Vec)PetscToPointer((g) ),*mode,
	(Vec)PetscToPointer((l) ));
}
PETSC_EXTERN void PETSC_STDCALL  dmdanaturaltoglobalend_(DM da,Vec g,InsertMode *mode,Vec l, int *__ierr ){
