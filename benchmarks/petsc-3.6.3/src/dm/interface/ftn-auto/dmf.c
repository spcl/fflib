...
PETSC_EXTERN void PETSC_STDCALL  dmgetdefaultsection_(DM dm,PetscSection *section, int *__ierr ){
*__ierr = DMGetDefaultSection(
	(DM)PetscToPointer((dm) ),section);
}
PETSC_EXTERN void PETSC_STDCALL  dmsetdefaultsection_(DM dm,PetscSection section, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  dmgetdefaultglobalsection_(DM dm,PetscSection *section, int *__ierr ){
*__ierr = DMGetDefaultGlobalSection(
	(DM)PetscToPointer((dm) ),section);
}
PETSC_EXTERN void PETSC_STDCALL  dmsetdefaultglobalsection_(DM dm,PetscSection section, int *__ierr ){
...
PETSC_EXTERN void PETSC_STDCALL  dmlocatepoints_(DM dm,Vec v,IS *cells, int *__ierr ){
