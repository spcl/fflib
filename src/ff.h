...
#define FF_UINT8_T  1
#define FF_INT16_T  2
#define FF_UINT16_T 3
#define FF_INT32_T  4
#define FF_UINT32_T 5
#define FF_INT64_T  6
#define FF_UINT64_T 7
#define FF_FLOAT    8
#define FF_DOUBLE   9
...
typedef uint32_t ff_rank_t;
typedef uint32_t ff_size_t;
typedef uint32_t ff_operator_t;
typedef uint32_t ff_datatype_t;
...
typedef uint32_t ff_tag;

typedef uint32_t ff_op_h;
typedef uint32_t ff_schedule_h;
typedef uint32_t ff_container_h;
